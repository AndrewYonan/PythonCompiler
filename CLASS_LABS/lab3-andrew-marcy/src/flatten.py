...
# All code necessary to flatten python code, 
# including RenameVariables, flatten_ast(), get_local_vars
...
def get_local_vars(py_prog_ast):
    name_counter = NameCounter()
    name_counter.visit(py_prog_ast)
